...
[Note]   
데이터 가공에 dplyr와 함께 자주 사용되는 패키지에 tidyr이 있습니다. dplyr와 tidyr에 대한 cheat sheet를 아래에서 다운로드 받아서 곁에 두고 참조하시기 바랍니다.   

## Reshaping data 
위 cheet sheet 에서 tidyr 패키지의 gather와 spread 함수를 사용합니다.  
